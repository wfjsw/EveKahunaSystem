...
class User():
    def __init__(self, user_name: str, display_name: str | None = None):
        self.user_name = user_name
        self.display_name = display_name or user_name
        # self.user_data.load_self_data()

    @classmethod
    def from_obj(cls, user_obj):
        return cls(user_name=user_obj.user_name, display_name=user_obj.display_name)
